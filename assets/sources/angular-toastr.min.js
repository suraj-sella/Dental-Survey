! function () {
	...
	function t(t, e, n, s, o, r, a) {
		...
		function l(t) {
			if (1 !== arguments.length || t)
				if (t) d(t.toastId);
					...
					for (var e = 0; e < B.length; e++) d(B[e].toastId)
		}
		...
		function g(t, e, n, s) {
			return angular.isObject(n) && (s = n, n = null), C({
				iconClass: t,
				message: e,
				optionsOverride: s,
				title: n
		...
		function h(e) {
			if (O) return $.promise;
			O = angular.element("<div></div>"), O.attr("id", e.containerId), O.addClass(e.positionClass), O.css({
				"pointer-events": "auto"
			});
		...
		function C(n) {
			...
			function p() {
				var t = f.preventDuplicates && n.message === x,
					e = f.preventOpenDuplicates && w[n.message];
			...
			if (!p()) {
				var m = l();
				if (B.push(m), r())
					for (var g = B.slice(0, B.length - f.maxOpened), C = 0, $ = g.length; C < $; C++) d(g[C].toastId);
	...
	function t(t, e, n, s) {
		function o(n, o, r, a) {
			...
			if (n.toastClass = n.options.toastClass, n.titleClass = n.options.titleClass, n.messageClass = n.options.messageClass, n.progressBar = n.options.progressBar, c()) {
				var p = angular.element(n.options.closeHtml),
					f = t.get("$compile");
